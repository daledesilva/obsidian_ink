...
- **19 – Migration Progress Density**: Many unique legacy files so scan/migrate progress bars and settings migrate-card collapse after permanent migration can be verified
