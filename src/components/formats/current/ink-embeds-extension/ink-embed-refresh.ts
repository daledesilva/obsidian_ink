...
import { clearAllInkCmScrollerScrollLocks } from 'src/components/jsx-components/finger-blocker/finger-blocker';
...
export function refreshLivePreviewEmbedsWhenReady(plugin: InkPlugin) {
	...
	const tryRefresh = () => {
		...
		// Workspace/panel changes often force-rebuild; clear any stranded pen scroll-lock first.
		clearAllInkCmScrollerScrollLocks('forceRebuild-live-preview-refresh');
