...
const WRITING_EMBED = ' ![InkWriting](<Notes/my-writing.svg>) [Edit Writing](https://youtu.be/abc?type=inkWriting&version=1)';
const DRAWING_EMBED = ' ![InkDrawing](<Ink/Drawing/my-drawing.svg>) [Edit Drawing](https://youtu.be/abc?type=inkDrawing&version=1&width=500&aspectRatio=1.78)';
...
describe('injectPendingPasteIntoEmbeds', () => {
  ...
  test('does not double-inject pendingPaste when already present', () => {
    const alreadyPending = ` ![InkWriting](<Notes/my-writing.svg>) [Edit Writing](https://youtu.be/abc?type=inkWriting&version=1&pendingPaste=true)`;
